...
class Music {
  ...
  Music({required this.title, required this.artist, required this.coverImageAssets});
}
...
class SectionWidget extends StatelessWidget {
  ...
  const SectionWidget({super.key, required this.title, required this.musicList});
